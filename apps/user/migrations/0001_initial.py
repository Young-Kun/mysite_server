    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.CharField(default='', max_length=125, verbose_name='账号')),
                ('account_type', models.CharField(choices=[('email', '邮箱'), ('mobile', '手机')], default='email', max_length=6, verbose_name='账号类型')),
